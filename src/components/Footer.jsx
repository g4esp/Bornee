    ...
    <section className="py-24">
      <div className="lg:w-10/12 w-11/12 mx-auto flex flex-col lg:flex-row gap-[15px]">
        <div className="lg:w-5/12">
          <h1 className="text-4xl font-bold">Bornee.</h1>
        ...
        <div className="lg:w-3/12 text-[#404040]">
          ...
          <p className="mt-[30px]">02301 - 15 Market St <br />Brockton, Massachusetts(MA)</p>
          <p className="mt-[30px]">(508) 857-1620 <br />hello@borne.com</p>
        </div>
